...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs) {
        ...
        pageBackground = a.getColor(R.styleable.LoadingLayout_pageBackground, UIUtil.getColor(R.color.base_loading_background));
        a.recycle();
    }
    ...
    private void build() {
       ...
       // aviLoading = UIUtil.findViewById(loadingPage, R.id.av_loading);
        errorText = UIUtil.findViewById(errorPage, R.id.error_text);
        emptyText = UIUtil.findViewById(emptyPage, R.id.empty_text);
        networkText = UIUtil.findViewById(networkPage, R.id.no_network_text);

        errorImg = UIUtil.findViewById(errorPage, R.id.error_img);
        emptyImg = UIUtil.findViewById(emptyPage, R.id.empty_img);
        networkImg = UIUtil.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = UIUtil.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = UIUtil.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(UIUtil.getColor(mConfig.tipTextColor));
        emptyText.setTextColor(UIUtil.getColor(mConfig.tipTextColor));
        networkText.setTextColor(UIUtil.getColor(mConfig.tipTextColor));
        ...
        errorReloadBtn.setTextColor(UIUtil.getColor(mConfig.buttonTextColor));
        networkReloadBtn.setTextColor(UIUtil.getColor(mConfig.buttonTextColor));

        if (mConfig.buttonHeight != -1) {

            errorReloadBtn.setHeight(UIUtil.dip2px(mConfig.buttonHeight));
            networkReloadBtn.setHeight(UIUtil.dip2px(mConfig.buttonHeight));
        }
        if (mConfig.buttonWidth != -1) {

            errorReloadBtn.setWidth(UIUtil.dip2px(mConfig.buttonWidth));
            networkReloadBtn.setWidth(UIUtil.dip2px( mConfig.buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        errorReloadBtn.setTextColor(UIUtil.getColor(id));
        networkReloadBtn.setTextSize(UIUtil.getColor(id));
        return this;
    }
    ...
    public LoadingLayout setDefineBackgroundColor(@ColorRes int color) {
        if (defineLoadingPage == null) {
            loadingPage.setBackgroundColor(UIUtil.getColor(color));
        } else {
            defineLoadingPage.setBackgroundColor(UIUtil.getColor(color));
        }
        errorPage.setBackgroundColor(UIUtil.getColor(color));
        emptyPage.setBackgroundColor(UIUtil.getColor(color));
        networkPage.setBackgroundColor(UIUtil.getColor(color));
        return this;
    }
