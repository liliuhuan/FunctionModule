...
//			tw.setShowDividers(TabWidget.SHOW_DIVIDER_NONE);
            ...
            ll.addView(tw, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT, 0));

            FrameLayout fl = new FrameLayout(context);
            fl.setId(android.R.id.tabcontent);
            ll.addView(fl, new LayoutParams(0, 0, 0));

            mRealTabContent = fl = new FrameLayout(context);
            mRealTabContent.setId(mContainerId);
            ll.addView(fl, new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, 0, 1));
        }
    }
