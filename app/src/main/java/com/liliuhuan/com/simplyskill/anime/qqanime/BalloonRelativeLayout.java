...
/**
 * Created by liliuhuan on 2017/9/12.
 */
...
public class BalloonRelativeLayout extends RelativeLayout {
    ...
    private ValueAnimator getBezierValueAnimator(final View target) {
        ...
        ValueAnimator animator = ValueAnimator.ofObject(evaluator, new PointF(random.nextInt(getWidth()), getHeight())
