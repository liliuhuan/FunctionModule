...
import com.liliuhuan.com.simplyskill.widget.ProgressView;
...
public class ProgressViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = (ProgressView) findViewById(R.id.circleProgress);
        findViews();
        initData();
    ...
    private void initData() {
        ...
        listSpeeds.add("4000");
        listSpeeds.add("5000");
        adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, listSpeeds);
...
//                Toast.makeText(ProgressViewActivity.this, "完成", Toast.LENGTH_SHORT).show();
//            }
//        });
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(data1)) {
                    Toast.makeText(ProgressViewActivity.this, "填写总成绩", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(data2)) {
                    Toast.makeText(ProgressViewActivity.this, "填写当前成绩", Toast.LENGTH_SHORT).show();
                    return;
                }
                totalScore = Integer.parseInt(data1);
                currentScore = Integer.parseInt(data2);
                if (currentScore > totalScore) {
                    Toast.makeText(ProgressViewActivity.this, "当前成绩不能大于总成绩", Toast.LENGTH_SHORT).show();
                    return;
